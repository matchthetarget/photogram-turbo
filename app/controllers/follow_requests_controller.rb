  ...
  def create
    ...
    respond_to do |format|
      if @follow_request.save
        format.html { redirect_back_or_to @follow_request.recipient, notice: "Follow request was successfully created." }
  ...
  def update
    respond_to do |format|
      if @follow_request.update(follow_request_params)
        format.html { redirect_back_or_to @follow_request.sender, notice: "Follow request was successfully updated." }
